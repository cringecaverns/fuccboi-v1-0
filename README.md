# fuccboi-v1-0
fuccboi-v1-0 discord bot for analizing gainz

# example usage:

```
@fuccboi GAINZ AMD JNUG
```

![default response example](/docs/default_response.png?raw=true "default_response")


```
@fuccboi GAINZ AMD JNUG display:sb
```

![example request to show bid and symbol](/docs/request.png?raw=true "example request to show bid and symbol")
